package mk.ukim.finki.emt.lab.web.handler;

import mk.ukim.finki.emt.lab.model.exception.AccommodationDeletionNotAllowedException;
import mk.ukim.finki.emt.lab.model.exception.AccommodationNotAvailableException;
import mk.ukim.finki.emt.lab.model.exception.AccommodationNotFoundException;
import mk.ukim.finki.emt.lab.web.controller.AccommodationController;
import mk.ukim.finki.emt.lab.web.dto.ApiError;
